...
if (discussion == null) {
	discussion = CommentManagerUtil.getDiscussion(discussionTaglibHelper.getDiscussionUserId(), discussionRequestHelper.getScopeGroupId(), discussionTaglibHelper.getClassName(), discussionTaglibHelper.getClassPK(), new ServiceContextFunction(renderRequest));
}
